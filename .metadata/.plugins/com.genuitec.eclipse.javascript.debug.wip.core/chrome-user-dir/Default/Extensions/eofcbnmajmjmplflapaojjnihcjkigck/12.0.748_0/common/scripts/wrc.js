    ...
    _.extend(AvastWRC,
        {
            ...
            avastConfig: {
                get: function (callback) {
                    AvastWRC.getStorage(this.config.localStorageKeyName, function (data) {
                        let localAvastConfig = JSON.parse(data);
                        ...
                        callback(localAvastConfig ? JSON.stringify(localAvastConfig) : localAvastConfig);
                    });
                ...
                set: function (avastConfig) {
                    ...
                    AvastWRC.setStorage(this.config.localStorageKeyName, JSON.stringify(avastConfigEncoded));
                },
                config: {
...
(function(AvastWRC) {
	...
	AvastWRC.Utils.buildUserSettingsMessage = function(settings){
		...
		_userSettings.advanced.coupons_configs.redirect_visibility = userSettings.notifications.others.showAlways ? 0 : 1;
	...
	AvastWRC.Utils.resolveImageUrl = function(primaryImage = "", secondaryImage = ""){

		let imagesMap = {
			"Finance.gif" : "Finance.gif",
			"Finance-repeat.gif" : "Finance-repeat.gif",
			"Insurance.gif" : "Insurance.gif",
			"Insurance-repeat.gif" : "Insurance-repeat.gif",
			"Security.gif" : "Security.gif",
			"Security-repeat.gif" : "Security-repeat.gif",
			"Vertical-Deals.gif" : "Vertical-Deals.gif",
			"Vertical-Deals-Repeat.gif" : "Vertical-Deals-Repeat.gif",
			"Vertical-Travel-Carrental.gif" : "Vertical-Travel-Carrental.gif",
			"Vertical-Travel-Carrental-repeat.gif" : "Vertical-Travel-Carrental-repeat.gif",
			"VerticalTravel-Flights.gif" : "VerticalTravel-Flights.gif",
			"Vertical-Travel-Flights-Repeat.gif" : "Vertical-Travel-Flights-Repeat.gif",
			"primarydefault" : "Vertical-Deals.gif",
			"secondarydefault" : "Vertical-Deals-Repeat.gif",
		};
		return {
			primaryImage : (primaryImage === "") ? getImageUrl(imagesMap["primarydefault"]) : (primaryImage.indexOf("http") != -1) ? primaryImage : (imagesMap[primaryImage]) ? getImageUrl(imagesMap[primaryImage]) : getImageUrl(imagesMap["primaryDefault"]),
			secondaryImage : (secondaryImage === "") ? getImageUrl(imagesMap["secondarydefault"]) : (secondaryImage.indexOf("http") != -1) ? secondaryImage : (imagesMap[secondaryImage]) ? getImageUrl(imagesMap[secondaryImage]) : getImageUrl(imagesMap["secondaryDefault"]),
		};
