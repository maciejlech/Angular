                        ...
                        switch (data.action) {
                            ...
                            case "shown":
                                ...
                                if (eventDetails.category === "COUPONS"){
                                    setTimeout(() => {
                                        AvastWRC.NotificationsManager.disableCouponsForDomain(data.domain || AvastWRC.bal.getDomainFromUrl(tab.url));
                                    }, 2000);                                    
                                }
                                (AvastWRC.Burger != undefined)? AvastWRC.Burger.emitEvent("burger.newEvent", eventDetails):console.log("no burger lib");
                                break;
...
(function(_,Shepherd) {
    ...
    _.extend(Shepherd,{
        ...
        getAnimationsConfig: function () {
            return this.rules.animations || false;
        }
    });
...
(function (AvastWRC, _) {
    AvastWRC.NotificationsManager = {
        ...
        isCategoryAvailableForDomain: function (domain, cateogry) {
            var cateogryFlag = this.config.onlyInMemoryValues.categoriesBlackListedOnDomain[domain] || 0;
            console.log(this.config.onlyInMemoryValues.categoriesBlackListedOnDomain[domain])
        ...
        resolvers: {
                    ...
                    resolvers: {
                        redirectIsAvailable: {
                            ...
                            resolvers: {
                                ...
                                isRedirectBlinkIcon: {
                                    resolver: (() => AvastWRC.NotificationsManager.resolvers.isRedirectBlinkIcon),
                        ...
                        onlyFirstRequestblinkIcon: {
                            resolver: (() => AvastWRC.NotificationsManager.resolvers.onlyFirstRequestblinkIcon),
                            action: (() => AvastWRC.NotificationsManager.blinkIcon.bind(AvastWRC.NotificationsManager))
                        }
                    }
                },
                ...
                notificationsAvailable: {
                    ...
                    resolvers: {
                        productsAreAvailable: {
                            resolver: (() => AvastWRC.NotificationsManager.resolvers.productsAreAvailable),
                            resolvers: {
                                        couponsAreAvailable: {
                                            resolver: (() => AvastWRC.NotificationsManager.resolvers.couponsAreAvailable),
                                            resolvers: {
                        ...
                        accommodationsAreAvailable: {
                            resolver: (() => AvastWRC.NotificationsManager.resolvers.accommodationsAreAvailable),
                            resolvers: {
                                couponsAreAvailable: {
                                    resolver: (() => AvastWRC.NotificationsManager.resolvers.couponsAreAvailable),
                                        resolvers: {
            ...
            isRedirectBlinkIcon: function (data) {
                return data && data.redirectLength && !AvastWRC.NotificationsManager.resolvers.isCoupons(data);
            },
            onlyFirstRequestblinkIcon: function (data) {
            ...
            isLoading: function (data) {
                ...
                return AvastWRC.NotificationsManager.isCategoryAvailableForDomain(data.urlDomain, categoryFlag) 
                    && data && data.couponsLength && !data.onlyFirstRequest;
            },
            ...
            couponsAreAvailable: function (data) {
                return (AvastWRC.bal.settings.get().userSPPoppupSettings.notifications.coupons.showAlways)
            ...
            productsAreAvailable: function (data) {
                return data.showPriceComparisonNotification  && AvastWRC.NotificationsManager.resolvers.isProducts(data);
            },
            accommodationsAreAvailable: function (data) {
                return AvastWRC.NotificationsManager.resolvers.isAccommodations(data);
            },
            ...
            isHotelsPriceComparison: function (data) {
                var categoryFlag = AvastWRC.NotificationsManager.config.messages.injected.showOffersNotification.notificationCategoryFlag;
                return AvastWRC.NotificationsManager.isCategoryAvailableForDomain(data.urlDomain, categoryFlag) 
                    && data && data.priceComparisonLength && data.showPriceComparisonNotification;
            },
