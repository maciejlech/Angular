 ...
 ******************************************************************************/
    AvastWRC.gpb.All.SafeShopOffer = PROTO.Message("AvastWRC.gpb.All.SafeShopOffer",{
        ...
        Redirect : PROTO.Message("AvastWRC.gpb.All.SafeShopOffer.Redirect",{
            RedirectCategory: PROTO.Enum("AvastWRC.gpb.All.SafeShopOffer.Redirect.RedirectCategory",{
                UNKNOWN_CATEGORY: 0,
                FINANCE: 1,
                PRICE_COMPARISON: 2,
                SECURITY: 3,
            ...
            RedirectSubCategory: PROTO.Enum("AvastWRC.gpb.All.SafeShopOffer.Redirect.RedirectSubCategory",{
            ...
            category:          GPBD.cType(12, PROTO.optional, function(){return AvastWRC.gpb.All.SafeShopOffer.Redirect.RedirectCategory;}),
            sub_category:      GPBD.cType(13, PROTO.optional, function(){return AvastWRC.gpb.All.SafeShopOffer.Redirect.RedirectSubCategory;}),
        ...
        OfferResponse : PROTO.Message("AvastWRC.gpb.All.SafeShopOffer.OfferResponse",{
            ...
            available_price_comparison: GPBD.bool(6, PROTO.optional)                       
        })
    });
